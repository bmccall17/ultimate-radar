...
|---|---|---|
| a graphic wipes the box fully white — ink 3200, every pixel of 80×40 | 1204.29, 2772.62, 6278.84, 6485.90 | the wipe |
| the bug re-renders after the replay, two frames 0.25 s apart | 1728.92, 5953.44 | the re-render |
